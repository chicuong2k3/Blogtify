...
$attribute: PostMetadata(Id = 1, Title = "Lập trình mạng phần 1 - Tổng quan về mạng máy tính", Category = "Mạng máy tính", LastModified = "30-09-2025", IsDraft=true)
...
<img src="/network-layer.png" alt="Các tầng giao thức TCP/IP" loading="lazy" />
<br>
