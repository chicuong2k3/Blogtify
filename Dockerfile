...
RUN dotnet publish "Blogtify.Client.csproj" -c ReleaseCompat -o /app/publishCompat --no-restore /p:RunAOTCompilation=true /p:BlazorEnableLinker=true /p:PublishTrimmed=true /p:BlazorWebAssemblyEnableCompression=true /p:BlazorWebAssemblyEnableBootResourceCompression=true
